// Refactored from https://github.com/contica-hakan-akerblom/ms-identity-javascript-react-tutorial/blob/main/1-Authentication/1-sign-in/SPA/src/authConfig.js
